...
Sha256.hash = function (msg, utf8encode) {
  ...
  const W = new Array(64); let a; let b; let c; let d; let e; let f; let g; let h;
  for (let i=0; i<N; i++) {
    // 1 - prepare message schedule 'W'
    for (let t=0; t<16; t++) W[t] = M[i][t];
    for (let t=16; t<64; t++) W[t] = (Sha256.sigma11(W[t-2]) + W[t-7] + Sha256.sigma00(W[t-15]) + W[t-16]) & 0xffffffff;
